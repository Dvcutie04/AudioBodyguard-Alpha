...
| Every exported source path | [Synchronization manifest](a-shell-sync-manifest.json) accounts for 441 paths: 432 exact, eight maintained, one retired | Describes the supplied a-Shell exports, not later edits on the phone |
