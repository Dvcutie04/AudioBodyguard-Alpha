...
The initial three hosted jobs passed in [Actions run 36066439795](https://github.com/Dvcutie04/AudioBodyguard-Alpha/actions/runs/36066439795); use the [PR checks](https://github.com/Dvcutie04/AudioBodyguard-Alpha/pull/2/checks) to verify the latest revision. Historical benchmark claims in older reports have not been revalidated in this restoration. A mock adapter or a test named “hardware-in-the-loop” is not evidence that a physical device was observed. See [restoration status](repository-restoration.md) for source provenance and remaining work.
